...
test_image_files = np.array(image_files[30000:])
name = name[30000:]
...
predictions_1 = [np.argmax(model.predict(np.expand_dims(tensor, axis=0))) for tensor in test_tensors]
...
final_dataset["category"] = predictions_1
